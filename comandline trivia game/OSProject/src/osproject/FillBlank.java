 ...
 * @author basil
 */
public class FillBlank extends Questions {

    private String[] answers;                 //an array to store the fill the blank questions answers
    private int nAnswers;                     //a variable to keep track of how many answers in the array

    public FillBlank(int size) {                //constructor
